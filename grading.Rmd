...
<!-- The aims of the projects are attempting to address one of the target areas of the Bloomberg American Health Initiative: https://www.jhsph.edu/about/bloomberg-american-health-initiative/index.html.  -->

#### Childhood Obesity

1.  List of all schools/districts in baltimore/Baltimore county
2.  Scrape data on school lunches in Baltimore County
3.  Get additional Income information for that county and obesity rates if possible
4.  Create an app that displays the differences based on obesity, fraction of people at reduced lunch, income level.

#### Potential Imbalances and the ASA

Characterize potential gender and under-represented minorities imbalances in American Statistical Association (ASA): http://www.amstat.org/

1. Scrape all programs from JSM.
2. Get information on the session:
  - Author names and affiliations 
  - Titles of talks
  - Indicator whether session was contributed or invited
  - Indicate if a section sponsored the 
  - Look at any panels on minority representation
3. Create an app that displays breakdowns of potential imbalances overall and over time.
