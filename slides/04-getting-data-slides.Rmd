...
```{r, eval=FALSE}
file_url <- paste0("https://data.baltimorecity.gov/api/", "views/dz54-2aru/rows.csv?accessType=DOWNLOAD")
...
`r rcode('library(devtools)')`

`r rcode('install_github("jennybc/googlesheets")')`
